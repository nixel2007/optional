...
Функции фильтрации и обработки могут задаваться с помощью "Описаний оповещения" (библиотека [notify](https://github.com/nixel2007/notify)).

> Поддержка строк и "Действий" запланирована.
